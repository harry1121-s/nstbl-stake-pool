...
interface IStakePool {
    ...
    * @param lpToken Address of the LP token
     */
    event StakePoolInitialized( uint256 version, address aclManager, address nstblToken, address loanManager, address atvl, address lpToken);
    ...
    */
    event StakePoolSetup( uint64 trancheStakeTimePeriod1, uint64 trancheStakeTimePeriod2, uint64 trancheStakeTimePeriod3);
    ...
    */
    function setupStakePool( uint16[3] memory trancheBaseFee, uint16[3] memory earlyUnstakeFee, uint8[3] memory stakeTimePeriods) external;
    ...
    */
    function getStakerInfo(address user, uint8 trancheId) external view returns (uint256 _amount, uint256 _poolDebt, uint256 _epochId, uint256 _lpTokens, uint256 _stakerTimeStamp);
