...
interface IStakePool {
     ...
     * @return poolProduct_ The yield of the pool
     */
    function previewUpdatePool() external view returns (uint256 poolProduct_);

    /**
     * @dev Gets the user's available tokens
     * @param user_ Address of the user
     * @param trancheId_ Tranche ID of the user
     * @return availableTokens_ The user's available tokens
     */
     ...
     * @return tokensUnstaked_ Amount of nSTBL received after unstaking
     */
    ...
    /**
     * @dev Gets the user's stake info
     * @param user_ Address of the user
     * @param trancheId_ Tranche ID of the user
